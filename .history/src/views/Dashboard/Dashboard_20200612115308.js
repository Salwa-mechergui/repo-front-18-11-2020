...
console.log(v.id_customer)
    await props.searchUserbyid(1, v.id_customer||1);
    await props.searchPassengers(v.id_customer||1);
    await props.searchCompanies(1, v.id_customer||1);
    await props.searchRides(1, v.id_customer||1, "way_to");
    setSelected(true);
    setUserData(true);
