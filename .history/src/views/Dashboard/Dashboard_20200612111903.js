...
function Dashboard(props) {
  ...
  const handleChange = async (id) => {
    ...
    const idCust = props.frontUsers[index].id_customer
    await props.searchUserbyid(1, idCust);
    await props.searchPassengers(idCust);
    await props.searchCompanies(1, idCust);
    await props.searchRides(1, idCust, "way_to");
    setSelected(true);
    setUserData(true);
