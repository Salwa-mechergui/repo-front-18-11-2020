...
console.log(v.id_customer)
    await props.searchUserbyid(1, v.id_customer);
    await props.searchPassengers(v.id_customer);
    await props.searchCompanies(1, v.id_customer);
    await props.searchRides(1, v.id_customer, "way_to");
    setSelected(true);
    setUserData(true);
