...
let idCustumer =v.id_customer 
    await props.searchUserbyid(1, idCustumer||1);
    await props.searchPassengers(idCustumer||1);
    await props.searchCompanies(1, idCustumer||1);
    await props.searchRides(1, idCustumer||1, "way_to");
    setSelected(true);
    setUserData(true);
