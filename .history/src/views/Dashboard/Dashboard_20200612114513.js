...
function Dashboard(props) {
  ...
  const handleChange = async (id) => {
    ...
    console.log(index)
console.log(props.frontUsers[index].id_customer)
    await props.searchUserbyid(1, props.frontUsers[index].id_customer);
    await props.searchPassengers(props.frontUsers[index].id_customer);
    await props.searchCompanies(1, props.frontUsers[index].id_customer);
    await props.searchRides(1, props.frontUsers[index].id_customer, "way_to");
    setSelected(true);
    setUserData(true);
